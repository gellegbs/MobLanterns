...
public class BlockSkeletonLantern extends BlockDirectional{
	...
	//icon junk
		...
		public void registerIcons(IconRegister register){
			topIcon = register.registerIcon(BlockIds.TEXTURE_LOCATION + ":" + BlockIds.SKELETONTOP);
			faceIcon = register.registerIcon(BlockIds.TEXTURE_LOCATION + ":" + BlockIds.SKELETONFRONT);
			blockIcon = register.registerIcon(BlockIds.TEXTURE_LOCATION + ":" + BlockIds.SKELETONSIDE);
		}

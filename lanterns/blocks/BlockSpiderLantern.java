...
public class BlockSpiderLantern extends BlockDirectional{
	public BlockSpiderLantern(int id, Material material){
		super(id, Material.pumpkin);
		this.setUnlocalizedName(BlockIds.SPIDER_UNLOCALIZED_NAME);
	...
	//icon junk
			...
			public void registerIcons(IconRegister register){
				topIcon = register.registerIcon(BlockIds.TEXTURE_LOCATION + ":" + BlockIds.SPIDERTOP);
				faceIcon = register.registerIcon(BlockIds.TEXTURE_LOCATION + ":" + BlockIds.SPIDERFRONT);
				blockIcon = register.registerIcon(BlockIds.TEXTURE_LOCATION + ":" + BlockIds.SPIDERSIDE);
			}

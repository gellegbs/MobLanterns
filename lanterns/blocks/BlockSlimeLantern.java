...
public class BlockSlimeLantern extends BlockDirectional{
	public BlockSlimeLantern(int id, Material material){
		super(id, Material.pumpkin);
		this.setUnlocalizedName(BlockIds.SLIME_UNLOCALIZED_NAME);
	...
	public void registerIcons(IconRegister register){
		topIcon = register.registerIcon(BlockIds.TEXTURE_LOCATION + ":" + BlockIds.SLIMETOP);
		faceIcon = register.registerIcon(BlockIds.TEXTURE_LOCATION + ":" + BlockIds.SLIMEFRONT);
		blockIcon = register.registerIcon(BlockIds.TEXTURE_LOCATION + ":" + BlockIds.SLIMESIDE);
	}

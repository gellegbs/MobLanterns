...
public class BlockPigmenLantern extends BlockDirectional{

	public BlockPigmenLantern(int id, Material material){
		super(id, Material.pumpkin);
		this.setUnlocalizedName(BlockIds.PIGMEN_UNLOCALIZED_NAME);
	...
	//icon junk
			...
			public void registerIcons(IconRegister register){
				topIcon = register.registerIcon(BlockIds.TEXTURE_LOCATION + ":" + BlockIds.PIGMENTOP);
				faceIcon = register.registerIcon(BlockIds.TEXTURE_LOCATION + ":" + BlockIds.PIGMENFRONT);
				blockIcon = register.registerIcon(BlockIds.TEXTURE_LOCATION + ":" + BlockIds.PIGMENSIDE);
			}

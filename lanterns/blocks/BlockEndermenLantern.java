...
public class BlockEndermenLantern extends BlockDirectional {
	...
	public void updateBlock(World world, int x, int y, int z) {
		...
		if (!world.isRemote && state) {
			Minecraft.getMinecraft().sndManager.playSound("mob.endermen.stare",

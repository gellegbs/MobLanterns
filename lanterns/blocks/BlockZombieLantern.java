...
public class BlockZombieLantern extends BlockDirectional {
	public BlockZombieLantern(int id, Material material) {
		...
		this.setUnlocalizedName(BlockIds.ZOMBIE_UNLOCALIZED_NAME);
	}
	...
	public void updateBlock(World world, int x, int y, int z) {
		...
		if (!world.isRemote && state) {
			Minecraft.getMinecraft().sndManager.playSound("mob.zombie.say",

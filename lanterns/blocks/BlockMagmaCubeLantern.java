...
public class BlockMagmaCubeLantern extends BlockDirectional{
	public BlockMagmaCubeLantern(int id, Material material){
		super(id, Material.pumpkin);
		this.setUnlocalizedName(BlockIds.MAGMA_UNLOCALIZED_NAME);
	...
	//icon junk
		...
		public void registerIcons(IconRegister register){
			topIcon = register.registerIcon(BlockIds.TEXTURE_LOCATION + ":" + BlockIds.MAGMATOP);
			faceIcon = register.registerIcon(BlockIds.TEXTURE_LOCATION + ":" + BlockIds.MAGMAFRONT);
			blockIcon = register.registerIcon(BlockIds.TEXTURE_LOCATION + ":" + BlockIds.MAGMASIDE);
		}

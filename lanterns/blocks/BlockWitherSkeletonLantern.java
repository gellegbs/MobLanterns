...
public class BlockWitherSkeletonLantern extends BlockDirectional{
	...
	//icon junk
		...
		public void registerIcons(IconRegister register){
			topIcon = register.registerIcon(BlockIds.TEXTURE_LOCATION + ":" + BlockIds.WITHERSKELETOP);
			faceIcon = register.registerIcon(BlockIds.TEXTURE_LOCATION + ":" + BlockIds.WITHERSKELEFRONT);
			blockIcon = register.registerIcon(BlockIds.TEXTURE_LOCATION + ":" + BlockIds.WITHERSKELESIDE);
		}
